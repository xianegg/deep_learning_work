...
os.makedirs('../train/photo', exist_ok=True)
os.makedirs('../train/sketch', exist_ok=True)
os.makedirs('../test/photo', exist_ok=True)
os.makedirs('../test/sketch', exist_ok=True)
for data_split, json_file in json_files.items():
    ...
    for image_name in attrs['image_name']:
        src = os.path.join('../photo', image_name)
        dst = os.path.join('..', data_split, 'photo', image_name.replace('/image', '_image'))
